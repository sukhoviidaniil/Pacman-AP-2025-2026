...
namespace model::collision {
    ...
    public:
        explicit HitBox_Circle(const int& strength, const math::Point2 &center, const float& radius);
        ...
        [[nodiscard]] std::vector<math::Vector2> get_vector_to(const HitBox &hit_boxe) const override;
